...
module FU (
    ...
    // 前推 A (rs1)
    assign fwd_a_ex  = (rs1_ex != 0) && (rs1_ex == rd_ex)  && reg_write_ex;
    assign fwd_a_mem = (rs1_ex != 0) && (rs1_ex == rd_mem) && reg_write_mem;

    // 前推 B (rs2)
    assign fwd_b_ex  = (rs2_ex != 0) && (rs2_ex == rd_ex)  && reg_write_ex;
    assign fwd_b_mem = (rs2_ex != 0) && (rs2_ex == rd_mem) && reg_write_mem;
